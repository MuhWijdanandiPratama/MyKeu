                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder">
                      ...
                      Rp<?= number_format($penghasilanHarian, 2, ',', '.') ?>
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pemasukan Mingguan</p>
                    <h5 class="font-weight-bolder">
                      Rp<?= number_format($penghasilanMingguan, 2, ',', '.') ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pemasukan Bulanan</p>
                    <h5 class="font-weight-bolder">
                      Rp<?= number_format($penghasilanBulanan, 2, ',', '.') ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Pendapatan Tahunan</p>
                    <h5 class="font-weight-bolder">
                      Rp<?= number_format($penghasilanTahunan, 2, ',', '.') ?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
    ...
    new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [<?php
                  for ($i = 0; $i < count($penghasilan_diagramBulanan); $i++) {
                    if ($penghasilan_diagramBulanan[$i] === null) {
                      echo '0,';
                    } else {
                      echo '"' . $penghasilan_diagramBulanan[$i] . '",';
                    }
