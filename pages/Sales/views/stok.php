  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="card">
      ...
      <div class="row">
        ...
        function getJenisKemasan($id_kemasan)
        {
          global $koneksi;

          $sql = "SELECT Jenis_kemasan FROM kemasan WHERE id_kemasan = '$id_kemasan'";
          $result = mysqli_query($koneksi, $sql);
          $row = $result->fetch_assoc();

          return $row["Jenis_kemasan"];
        }
          ...
          <div class="col-lg-3">
            <div class="card mb-3">
              ...
              <div class="card-body pt-0 p-3 text-center">
                <h6 class="text-center mb-0">Jenis Produk : <?= $row['Jenis_produk'] ?></h6>
                <h6 class="text-center mb-0">Jenis Kemasan : <?= getJenisKemasan($row['id_kemasan']) ?></h6>
                <span class="text-xs">Total Stok : <?= $row['Jumlah_produk'] ?></span>
                <hr class="horizontal dark my-3">
                <h5 class="text-sm">Harga : <?= $row['Harga_produk'] ?></h5>
              </div>
            </div>
          </div>
        <?php endwhile; ?>
