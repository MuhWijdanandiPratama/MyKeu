    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="../proccess/simpan_mitra.php" method="post">
                    <div class="form-group">
                        <label>Nama Outlet / Mitra</label>
                        <input name="outlet" id="outlet" type="text" required class="form-control" placeholder="Masukkan Nama Outlet / Mitra">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" id="alamat" required class="form-control" cols="50" rows="10" placeholder="Masukkan Alamat"></textarea>
                    </div>
                    <div class="form-group">
                        <label>No. Hp</label>
                        <input name="hp" type="tel" required class="form-control" placeholder="Masukkan No Hp">
                    </div>
                    <div class="form-group">
