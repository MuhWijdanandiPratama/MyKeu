    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="../proccess/simpan_pengeluaran.php" method="post">
                    <div class="form-group">
                        <label>Total Pengeluaran</label>
                        <input name="pengeluaran" id="pengeluaran" type="number" min="0" required class=" form-control" placeholder="Masukkan Total Pengeluaran Rp.">
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <input name="keterangan" id="keterangan" type="text" required class="form-control" placeholder="Tambahkan Keterangan">
                    </div>
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input name="tanggal" id="tanggal" type="date" required class="form-control" placeholder="Masukkan Tanggal">
                    </div>
                    <div class="form-group">
