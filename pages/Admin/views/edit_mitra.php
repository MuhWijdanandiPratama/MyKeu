      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="card">
            <div class="card-header">
                <a href="mitra.php" class="btn btn-primary btn-icon-split">
            ...
            <div class="card-body">
                <form action="../proccess/update_mitra.php" method="post">
                    <?php
                    ...
                    <div class="form-group">
                        <input name="id" type="hidden" value="<?= $row['id_mitra'] ?>" required class="form-control" placeholder="Masukkan Nama Outlet / Mitra">
                    </div>
                    <div class="form-group">
                        <label>Nama Outlet / Mitra</label>
                        <input name="outlet" type="text" value="<?= $row['nama'] ?>" required class="form-control" placeholder="Masukkan Nama Outlet / Mitra">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea name="alamat" id="alamat" required class="form-control" cols="50" rows="10" placeholder="Masukkan Alamat"><?= $row['alamat'] ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>No. Hp</label>
                        <input name="hp" type="tel" value="<?= $row['no_hp'] ?>" required class="form-control" placeholder="Masukkan No Hp">
                    </div>
                    <div class="form-group">
