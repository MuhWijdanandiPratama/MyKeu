...
<body onload="window.print(); window.onafterprint = function(event) {window.location.href = '../views/laporan_penghasilan.php'}" class="g-sidenav-show bg-gray-100">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6 class="text-center">LAPORAN PENGHASILAN</h6>
                            <?php if ($i === '1') : ?>
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jenis Kemasan</th>
                                        ...
                                        <?php foreach ($rows as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="text-sm font-weight-bold mb-0">
                                                        <?= date_format(date_create($row['tgl_transaksi']), 'd M Y') ?>
                                                    </p>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
