...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Agu 2022 pada 00.09
...
(6, 620220807, 'Kacang', 6, 'mete', '9000', 1, '2022-08-07', '2022-08-07', 100);
...
--
ALTER TABLE `transaksi`
  MODIFY `Id_transaksi` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94999;
